    ...
    def forward(self, maskGT, ref):
        ...
        for i in range(self.layers):
            ...
            if i < self.layers - 1:
                ...
                # concat ref features !
                out.append(torch.cat([x_maskGT, x_ref], dim=1))
        return out
...
class LNet(nn.Module):
    def __init__(
        ...
        self.decoder = decoder(image_nc, self.descriptor_nc,
                               base_nc, max_nc, layer, num_res_blocks, **kwargs)
