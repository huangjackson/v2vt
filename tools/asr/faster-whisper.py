# Includes modified code from https://github.com/RVC-Boss/GPT-SoVITS/blob/main/tools/asr/fasterwhisper_asr.py
# For licensing see licenses/LICENSE.GPT-SoVITS
